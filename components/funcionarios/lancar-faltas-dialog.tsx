...
import { useOcorrencias, useCreateOcorrencia, useDeleteOcorrencia } from "@/lib/queries/ocorrencias"
...
export function LancarFaltasDialog({
  ...
  const deleteOcorrencia = useDeleteOcorrencia(selectedFuncionarioId, contratoId, mesReferencia)
          ...
          {selectedFuncionarioId && (
            <div className="mt-4 flex flex-col gap-2">
              <h4 className="text-sm font-semibold">
                Histórico Recente ({mesReferencia})
              </h4>
